...
class ShadowCardControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should get play_screen' do
    get shadow_cards_play_screen_url @sauron
    assert_response :success
  end
  ...
  test 'should play card' do
    ...
    @sauron.save!
    post shadow_cards_play_url @sauron, params: { selected_card: 8 }
  ...
  test 'should get draw_screen' do
    get shadow_cards_draw_screen_url @sauron
    assert_response :success
  end
  ...
  test 'should draw cards' do
    ...
    @sauron.save!
    post shadow_cards_draw_url @sauron, params: { nb_cards: 6 }
    assert_redirected_to shadow_cards_keep_screen_url(@sauron)
